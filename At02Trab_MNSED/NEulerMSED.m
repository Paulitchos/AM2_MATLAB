...
%NEulerMSED   Método Númerico para resolver um Sistema se SED/PVI: Método de Euler Melhorado
%   y = NEulerMSED(f,g,a,b,n,u0,v0) Método numérico para a resolução de um PVI
%
%INPUT:
